    ...
    return (
        <>
            < div className="pt-4 p-3 mx-auto">
                <h3 style={fontStyling}>What is Productiv?</h3>
                <p style={fontStyling}>Productiv is an online <a style={{ textDecoration: 'none' }} href="https://en.wikipedia.org/wiki/Pomodoro_Technique" target="_blank"><span style={higlight}> pomodoro timer </span> </a>
                    that helps you stay focused for longer.</p>
                <h3 style={fontStyling}>The pomodoro Technique</h3>
                ...
                <h3 style={fontStyling}>How to use the timer</h3>
